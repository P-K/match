...
DATABASES = {
    'default': {
        ...
        'USER': 'matcher',
        'PASSWORD': os.environ.get('db_pass'), # pull password from heroku environ var
...
SECRET_KEY = 'v9b_2&ue^ws&=gah5+bnf87#+2+wt7_16q-f^^)(byc@n7q=6e'
...
ROOT_URLCONF = 'mmm_match.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mmm_match.wsgi.application'
